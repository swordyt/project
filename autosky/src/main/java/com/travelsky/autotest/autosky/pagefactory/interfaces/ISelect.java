...
public abstract interface ISelect
{
  ...
  public abstract void setOptionByValue(String paramString);

  public abstract void setOptionByText(String paramString);

  public abstract void setOptionByIndex(int paramInt);

  public abstract void setOptionByRand(int paramInt1, int paramInt2);

  public abstract void setOptionByRand();

  public abstract List<String> getSelectedTextList();

  public abstract List<String> getSelectedValueList();

  public abstract List<Element> getOptionList();

  public abstract List<String> getOptionTextList();
}

/* Location:           E:\MyEclipse\maven3\MVNrepo\com\travelsky\autotest\autosky\3.0.4\autosky-3.0.4.jar
 * Qualified Name:     com.travelsky.autotest.autosky.pagefactory.interfaces.ISelect
