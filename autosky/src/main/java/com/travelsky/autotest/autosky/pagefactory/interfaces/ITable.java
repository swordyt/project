...
public abstract interface ITable
{
  ...
  public abstract List<Element> getRowList();

  public abstract List<List<String>> getRowTextList();
 ...
 * Qualified Name:     com.travelsky.autotest.autosky.pagefactory.interfaces.ITable
