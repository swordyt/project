...
public abstract interface IRow
{
  ...
  public abstract List<Element> getCellList();

  public abstract Map<String, Integer> getCellTextIndexMap();

  public abstract List<String> getCellTextList();
}

/* Location:           E:\MyEclipse\maven3\MVNrepo\com\travelsky\autotest\autosky\3.0.4\autosky-3.0.4.jar
 * Qualified Name:     com.travelsky.autotest.autosky.pagefactory.interfaces.IRow
